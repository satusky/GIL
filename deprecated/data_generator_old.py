...
def get_image_set_size(file_list, index_first=False):
    ...
    return num_images, min_height, min_width


def split_and_resize(file_list, test_ratio, auto_resize=False, index_first=False):
    ...
    train_image_count, train_min_height, train_min_width = get_image_set_size(train_images, index_first=index_first)
    test_image_count, test_min_height, test_min_width = get_image_set_size(test_images, index_first=index_first)
    ...
    return train_images, train_labels, train_image_count, test_images, test_labels, test_image_count, input_shape
